    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-secondary-900 mb-2">Join AmiQuiz</h1>
          ...
          <div className="card-body p-8">
            <form onSubmit={handleEmailRegister} className="space-y-6">
              ...
              <div className="form-group">
                ...
                <div className="form-help">Password must be at least 6 characters long</div>
              </div>
              ...
              <div className="form-group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`input pl-10 pr-10 ${confirmPassword && password !== confirmPassword ? 'input-error' : ''}`}
