      ...
      <div className="flex-1 flex flex-col">
          ...
          <div className="container-fluid">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                <div className="flex items-center justify-center w-10 h-10 bg-[#003366] rounded-lg mr-3">
        ...
        <main className="container-fluid py-8 flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="stat-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <span className="font-semibold text-secondary-700 mb-2">Today's Schedule</span>
              <span className="text-2xl font-bold text-[#003366]">--</span>
              <span className="text-xs text-secondary-400 mt-2">No events</span>
            </div>
            <div className="stat-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <span className="font-semibold text-secondary-700 mb-2">Next Test</span>
              <span className="text-2xl font-bold text-[#003366]">--</span>
              <span className="text-xs text-secondary-400 mt-2">No upcoming</span>
            </div>
            <div className="stat-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <span className="font-semibold text-secondary-700 mb-2">Pending Tasks</span>
              <span className="text-2xl font-bold text-[#003366]">--</span>
              <span className="text-xs text-secondary-400 mt-2">All clear</span>
            </div>
            <div className="stat-card bg-white rounded-xl shadow p-6 flex flex-col items-center">
              <span className="font-semibold text-secondary-700 mb-2">Performance Trend</span>
              <span className="text-2xl font-bold text-[#003366]">--</span>
              <span className="text-xs text-secondary-400 mt-2">No data</span>
            </div>
          </div>
          {/* Progress Charts */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            <div className="bg-white rounded-xl shadow p-6">
              <h4 className="font-semibold text-secondary-900 mb-4">Weekly Progress</h4>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={weeklyData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  ...
                  <Legend />
                  <Line type="monotone" dataKey="score" stroke="#003366" strokeWidth={3} dot={{ r: 5, fill: '#FFD600' }} activeDot={{ r: 7 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            <div className="bg-white rounded-xl shadow p-6">
              <h4 className="font-semibold text-secondary-900 mb-4">Monthly Progress</h4>
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={monthlyData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                  <XAxis dataKey="week" stroke="#003366" fontSize={12} />
                  <YAxis stroke="#003366" fontSize={12} domain={[0, 100]} />
                  <Tooltip contentStyle={{ background: '#fff', borderColor: '#003366' }} />
                  <Legend />
                  <Line type="monotone" dataKey="score" stroke="#003366" strokeWidth={3} dot={{ r: 5, fill: '#FFD600' }} activeDot={{ r: 7 }} />
